...
// This script provides output suitable for CSV filing and is used in pair with ultrasoundCsvReader notebook
...
void loop() {
  ...
  // Print raw and filtered (convert to meters later processing)
  // Print CSV: time (s), raw_m, filt_m, vel_m_s
  ...
  Serial.print(x00, 3);
  Serial.print(",");
  Serial.println(x10, 3);


  // small delay to avoid overwhelming serial
  // careful not to make it too much more than the master-slave cycle
  delay(20);
}
